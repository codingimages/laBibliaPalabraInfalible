<?php
$page_title = 'La Biblia, Palabra Infalible Blog';
...
<head>
  ...
  <title>About us Roca Eterna</title>
</head>
...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-light bg-white">
    <a class="navbar-brand nav-title text-dark" href="index.html">
      <img src="img/logo.png" width="30" height="30" class=" d-inline-block align-top" alt="logo">Palabra Infalible</a>
  ...
  <!-- Navbar ends -->
    ...
    <main>
        ...
        <div class="container-fluid">
                <img class = "img-fluid" width = "100%" height = "auto" src="img/logo.png" alt="">
        </div>

        <div class="container mt-5 mb-5">
            <h2 class="heading-secondary">Bienvenidos a nuestro blog</h2>
            ...
            <div class="row">
                ...
                <aside class="col-12 col-lg-4 mt-5 mb-5">
                    <div class="p-3 mb-3 bg-light rounded __web-inspector-hide-shortcut__">
                        ...
                        <p class="mb-0">En la Biblia <em>Palabra Infalible</em> <br>Nuestro propósito es llevar el mensaje de la palabra de Dios inspirados por el Espíritu Santo.</p>
                    </div>
